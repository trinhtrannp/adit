...
from adit.dashboard import datafeed_doc, datahealth_doc
...
class AditWebApp:
    ...
    def __init__(self):
        ...
        self.caches = {
            'datamonitor': DataMonitorCache.instance()
        }
        ...
        dask_http_cfg['routes'].append('adit.dashboard.adit_dashboard')
